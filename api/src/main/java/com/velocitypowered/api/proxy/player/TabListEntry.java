...
public interface TabListEntry extends KeyIdentifiable {
  ...
  /**
   * Returns the {@link GameProfile} of the entry, which uniquely identifies the
   * entry with the
   * containing {@link java.util.UUID}, as well as deciding what is shown as the
   * player head in the
   * tab list.
   *
  ...
  /**
   * Returns {@link Optional} text {@link net.kyori.adventure.text.Component},
   * which if present is
   * the text displayed for {@code this} entry in the {@link TabList}, otherwise
   * {@link GameProfile#getName()} is shown.
   *
   * @return {@link Optional} text {@link net.kyori.adventure.text.Component} of
   *         name displayed in
   *         the tab list
   */
  ...
  /**
   * Sets the text {@link Component} to be displayed for {@code this}
   * {@link TabListEntry}. If
  ...
  /**
   * Returns whether or not this player will be visible to other players in the
   * tab list.
   *
  ...
  class Builder {
    ...
    /**
     * Sets the parent {@link TabList} for this entry, the entry will only be able
     * to be added to
     ...
     * <p>
     * This only works for players currently <b>not</b> connected to this proxy.
     * </p>
     * <p>
     * For any player currently connected to this proxy this will be filled
     * automatically.
     * </p>
     * <p>
    ...
    /**
     * Constructs the {@link TabListEntry} specified by {@code this}
     * {@link Builder}.
     *
