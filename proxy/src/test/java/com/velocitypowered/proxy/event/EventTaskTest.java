...
public class EventTaskTest {
  ...
  /**
   * An extremely simplified implementation of {@link Continuation} for verifying
   * the completion of
   * an operation.
   */
  private static class WitnessContinuation implements Continuation {

    private static final AtomicIntegerFieldUpdater<WitnessContinuation> STATUS_UPDATER = AtomicIntegerFieldUpdater
        .newUpdater(WitnessContinuation.class, "status");
