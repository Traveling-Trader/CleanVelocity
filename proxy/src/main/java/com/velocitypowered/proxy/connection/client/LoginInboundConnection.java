...
public class LoginInboundConnection implements LoginPhaseConnection {
  ...
  private static final AtomicIntegerFieldUpdater<LoginInboundConnection> SEQUENCE_UPDATER = AtomicIntegerFieldUpdater
      .newUpdater(LoginInboundConnection.class, "sequenceCounter");
